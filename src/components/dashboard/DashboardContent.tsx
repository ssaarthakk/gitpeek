                                ...
                                >
                                    {filteredRepos.map((repo) => (
                                        <ListboxItem
                                            ...
                                            className="text-white/90 hover:bg-white/10 max-w-[99%]"
                                        >
                                            <div className="flex items-center gap-3 max-w-full">
                                                ...
                                                <div className="flex-1 min-w-0 max-w-[calc(100%-8rem)] overflow-hidden">
                                                    <p className="font-medium truncate">{repo.name}</p>
                                                    <p className="text-sm text-white/50 truncate overflow-hidden max-w-[90%]">{repo.description || 'No description'}</p>
                                                </div>
                                                {repo.private && (
